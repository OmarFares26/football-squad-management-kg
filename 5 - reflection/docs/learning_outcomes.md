...
```text
3 - ML/src/embeddings.py
3 - ML/results/player_embeddings.csv
3 - ML/results/player_embedding_similarities.csv
3 - ML/graphs/squad_management_kg_with_embeddings.graphml
3 - ML/results/kg_with_embeddings_stats.csv
3 - ML/results/kg_with_embeddings_edge_counts.csv
```
...
```text
4 - logic/src/rule_engine.py
2 - construction/src/kg_builder.py
2 - construction/src/kg_queries.py
4 - logic/docs/decision_rules.md
4 - logic/results/squad_decisions_all_players.csv
2 - construction/results/query_blocked_by_main_player.csv
2 - construction/results/query_liverpool_blocked_examples.csv
```
...
```text
2 - construction/docs/kg_schema.md
5 - reflection/docs/portfolio_notes.md
2 - construction/src/kg_builder.py
5 - reflection/src/data_model_comparison.py
5 - reflection/results/data_model_comparison.csv
5 - reflection/results/data_model_comparison_examples.csv
5 - reflection/graphs/squad_management_kg.ttl
```
...
```text
2 - construction/src/data_preprocessing.py
2 - construction/src/performance_scoring.py
4 - logic/src/rule_engine.py
2 - construction/src/kg_builder.py
2 - construction/src/kg_queries.py
5 - reflection/src/service_output.py
3 - ML/src/embeddings.py
run_pipeline.py
2 - construction/docs/kg_schema.md
```
...
4 - logic/src/rule_engine.py
2 - construction/src/kg_builder.py
4 - logic/results/decision_counts.csv
4 - logic/results/decision_by_role.csv
```
...
2 - construction/results/kg_stats.csv
2 - construction/results/kg_node_counts.csv
2 - construction/results/kg_edge_counts.csv
2 - construction/docs/kg_schema.md
```
...
```text
5 - reflection/src/service_output.py
5 - reflection/results/liverpool_squad_decision_service.csv
5 - reflection/results/liverpool_squad_decision_summary.csv
5 - reflection/docs/portfolio_notes.md
```
...
2 - construction/src/kg_queries.py
5 - reflection/results/liverpool_squad_decision_service.csv
2 - construction/results/query_liverpool_decisions.csv
2 - construction/results/query_liverpool_blocked_examples.csv
```
